...
<body class="p-0 m-0" style="width:100%; height:100%;">
    ...
    <div class="container d-flex justify-content-start">
        <form action="" method="post" id="userdata" name="userdata">
            ...
            <span>Le modèle :</span> <input type="text" name="model" id="model"   />
            <p><?php echo form_error('model'); ?></p>

            <span>La puissance :</span> <input type="text" name="power"  id="power"   />
            <p><?php echo form_error('power'); ?></p>

            <span>La batterie :</span> <input type="text" name="batterysize" id="batterysize"   />
            <p><?php echo form_error('batterysize'); ?></p>

            <span>La couleur :</span> <input type="text" name="color"  id="color"   />
            <p><?php echo form_error('color'); ?></p>

            <span>Le kilomètrage :</span> <input type="text" name="kilometer"  id="kilometer"   />
            <p><?php echo form_error('kilometer'); ?></p>

            <span>La disponibilité :</span> <input type="text" name="disponibility"  id="disponibility"   />
            <p><?php echo form_error('disponibility'); ?></p>

            <span>Autopilot:</span> <input type="text" name="autopilot"  id="autopilot"   />

            <p><?php echo form_error('autopilot'); ?></p>

            <span>Le prix :</span> <input type="text" name="dailyprice" " id="dailyprice"   />
