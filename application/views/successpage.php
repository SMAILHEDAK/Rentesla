...
<nav class="navbar navbar-expand-sm navbar-light">
    ...
    <div class="container-fluid d-flex justify-content-center align-items-center" style="height:60%;">
        <div class="text-center">
            <h1 class="text-success">Merci de votre confiance!</h1>
            <p class="lead"><strong>Vous recevrez un mail de confirmation et la facture sous peu,</strong> si vous avez choisi la livraison par autopilot, un lien vers le suivi de livraison vous sera envoyé.</p>
            <hr>
            <p>
                Un probleme? <a href="">Contactez nous!</a>
            </p>
            <p class="lead">
                <a class="btn btn-sm" href="logged_main" role="button">Retour à l'accueil</a>
            </p>
        </div>
    </div>
    <footer>
